export const enquiryTopics = [
  { value: "terra-elegance", label: "Terra Elegance (Sohna floors)" },
  { value: "terra-heights", label: "Terra Heights (High-rise preview)" },
  { value: "terra-oasis", label: "Terra Oasis (Residential plots)" },
  { value: "general", label: "General Corporate Enquiry" },
  { value: "partnership", label: "Landowner Collaboration / JVs" },
];

export const quickContacts = {
  salesPhone: "+91 124 3633146",
